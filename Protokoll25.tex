...
Wie im Versuch \textsc{Adiabatenexponent} erläutert, trägt jeder der $f$ Freiheitsgrade jedes der $N$ Atome die Energie $\frac{2}{2}k_BT$.
...
In Festkörpern können definitionsgemäß keine Translationen und Rotationen statfinden, da die Stoffe fixiert sind.
