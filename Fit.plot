...
fit G(x) 'kuehlenBe.dat' u ($1*60):(log(T($2)-T0)*10**5):(U($2)*V/(T($2)-T0)*10**5) via g,h
...
fit O(x) 'stickstoffBeKuehlen.dat' u ($1*60):(log(T($2)-T2)*10**5):(U($2)*V/(T($2)-T1)*10**5) via o,p
